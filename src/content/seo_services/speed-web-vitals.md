---
h1: Speed + Core Web Vitals
heroSubtitle: "Make your site feel instant on mobile. Fix the stuff that hurts UX (and rankings): LCP, CLS, INP, heavy images, and bloated scripts."
introBullets:
...
p1: Speed is conversion. A fast site feels trustworthy and makes it easier for people to take action—especially on phones.
p2: "Core Web Vitals are the measurable side of that: load time (LCP), layout stability (CLS), and responsiveness (INP). I’ll identify what’s hurting your scores and fix the bottlenecks."
faqs:
  - q: Will this help SEO?
    a: Yes. Speed and Core Web Vitals can affect rankings, and they almost always improve conversions because people stop bouncing.
  - q: What’s usually slowing a site down?
    a: Huge images, too many scripts, heavy embeds, and builder bloat. We fix the biggest offenders first.
  - q: Do you need access to my hosting?
    a: Sometimes. Many fixes can be done in code, but caching/CDN settings may need host access. We’ll keep it minimal.
