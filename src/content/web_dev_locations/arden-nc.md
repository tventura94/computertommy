...
faqs:
  - q: "What makes an Arden website different from an Asheville template site?"
    a: >
      Arden searches are often service-area driven (Airport Rd, Long Shoals,
      Hendersonville Rd, I-26 corridor), so the site needs clear coverage, fast
      mobile load, and an obvious path to call or request a quote—without
      pretending you’re based in five different cities.
  - q: "Can you help me avoid doorway-page SEO issues?"
    a: >
      Yes. The goal isn’t to churn out near-duplicate city pages—it’s to build
      one strong primary site with real, specific info (services, areas you
      actually serve, proof, FAQs). If we add location content, it’s only when
      it’s genuinely unique and useful.
  - q: "I’m near the airport and get a lot of near-me searches. Can the site capture that?"
    a: >
      Absolutely. We can structure headings and copy around how people search
      (service + area, “near me,” and map-driven traffic), then make the
      conversion step frictionless on mobile.
  - q: "Do you build sites for small teams and local service businesses?"
    a: >
      Yes. The best fit is a straightforward business that needs a clean site:
      clear services, trust signals, and a simple way for customers to reach you.
  - q: "Is hosting or maintenance locked into a contract?"
